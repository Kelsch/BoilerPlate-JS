...
function resetModal() {
    ...
    let remainingModal = document.querySelector('.loadDetailsContainer-show');
    if (remainingModal !== null) {
        // console.log(remainingModal.querySelector('.loadDetails-loadName'), remainingModal.querySelector('.loadDetails-loadName').click(), this)
    }
}
