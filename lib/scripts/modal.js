...
function doDrag(e) {
    if (e.target.classList.contains('loadDetails-content') && !e.target.classList.contains('loadDetails-loadName') && e.type == "mousemove" && typeof window.orientation != 'undefined') {
        return;
    }
