...
function infoLoader() {
    ...
    resizable.style.height = `${infoModalContent.clientHeight + 22 + 5}px`;

    // This only works on the second click because it is running multiple twice and only works when it is odd
    console.log('info')
}
