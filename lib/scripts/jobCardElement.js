...
class JobCard extends HTMLElement {
    ...
    connectedCallback() {
        let jobObj = { name: this.getAttribute('jobname'), address: this.getAttribute('jobaddress'), cabinetCount: this.getAttribute('jobcabinetcount'), shippingNotes: this.getAttribute('jobshippingnotes') };

        let shippingNoteHTML = () => html`<span class="loadDetails-jobShippingNoteLabel">Shipping Notes:</span>`;
